...
/**
 * Request type for adding backup information.
 * 
 * 백업 정보를 추가하기 위한 요청 타입입니다.
 * 
 * @category CMS Requests
 * @since 1.0.0
 */
export type AddBackupInfoCmsRequest = BaseCmsRequest & {
    /**
     * Task type - must be 'addbackupinfo'
     * 작업 타입 - 'addbackupinfo'로 고정
     */
    task: 'addbackupinfo';
