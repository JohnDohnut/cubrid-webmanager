...
export const CM_KO = {
  ...
  planUpdatedMsg: (id) => `질의 자동화 "${id}"이(가) 성공적으로 업데이트되었습니다.`,
  addQueryPlanFailedMsg: '질의 자동화 추가에 실패했습니다.',
  ...
  backupPlanUpdatedMsg: (id) => `백업 자동화 ${id}이(가) 성공적으로 업데이트되었습니다.`,
  ...
  backupPlanRemovedMsg: (id) => `백업 자동화 ${id}이(가) 삭제되었습니다.`,
