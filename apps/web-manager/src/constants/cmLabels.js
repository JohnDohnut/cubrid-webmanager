...
export const CM = {
  ...
  cubridWebManager: 'Next CUBRID Admin',
  ...
  changeManagerPasscode: 'Change Manager Password',
  newPasscode: 'New Password',
  verifyNewPasscode: 'Verify New Password',
  ...
  brokerParamsNotice: 'Broker parameters define how Next CUBRID Admin connects to the CUBRID Broker. These changes only affect Next CUBRID Admin\'s connection to this host.',
  ...
  webManagerConnectionDesc: (db) => `Configure how Next CUBRID Admin connects to ${db}. These parameters define how the Next CUBRID Admin communicates with the CUBRID Broker.`,
  ...
  haDbActive: 'Active',
  haDbStandby: 'Standby',
  haDbToBeActive: 'To-be-active',
  haDbToBeStandby: 'To-be-standby',
  haDbMaintenance: 'Maintenance',
  haDbDead: 'Dead',
  haDbIdle: 'Idle',
  ...
  workspaceDesktopOnlyDesc: 'Workspace settings are available in the Next CUBRID Admin desktop app.',
  ...
  passcodeUpdated: 'Password Updated',
  ...
  importHostsDesc: 'Import hosts from a Next CUBRID Admin or CUBRID Admin export file.',
  exportFormatLabel: 'Format:',
  formatCaXml: 'CUBRID Admin XML',
  formatNativeXml: 'Next CUBRID Admin XML',
  formatNativeJson: 'Next CUBRID Admin JSON',
  ...
  importFormatHelp: 'Next CUBRID Admin XML/JSON, CUBRID Admin hosts XML, or legacy desktop .prefs / .properties. Host groups are preserved where the format supports them. Encrypted passwords in .prefs are not imported.',
  ...
  weakNewPasswordMsg: 'The new password does not meet the policy: at least 8 characters, including a letter and a number.',
  currentPasswordIncorrectMsg: 'The current password is incorrect.',
  ...
  updatePasscode: 'Update Password',
  passcodeChangedSuccessMsg: (host) => `The manager access password for ${host} has been successfully changed.`,
  passcodeUpdateNote: 'This changes the CMS account password for the currently logged-in user. It also updates the manager access password stored locally for this connection.',
