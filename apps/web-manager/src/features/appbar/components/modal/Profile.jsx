    ...
    <>
      <Modal
        ...
        footer={() => {
          return (
            <div
              style={{ width: '100%', display: 'flex', gap: '12px', justifyContent: 'flex-end' }}
            >
              <Button type={'primary'} onClick={() => setDeleteUser(true)} className={'error'}>
                Unregister
              </Button>
      ...
      >
        <Form form={form} layout="vertical" name="create_user_form">
          ...
          <Text
            onClick={() => dispatch(setUpdatePassword(true))}
