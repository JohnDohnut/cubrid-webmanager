        ...
        <div style={{ display: 'flex', width: '100%', gap: 18 }}>
          <div className={'img__cubrid'}>
            <img
              width={100}
              src={
                'https://www.cubrid.org/files/attach/images/3771164/522cf9a9415e01599545be25bfd8eab3.png'
              }
              alt={'cubrid logo'}
            />
          </div>
          <div className={''}>
            ...
            <div>
              Copyright (C) 2025 Search Solution Corporation. All rights reserved by Search
              Solution.
              <div>
                Website:{' '}
                <a href={'http://www.cubrid.org'} target={'_blank'}>
                  http://www.cubrid.org
                </a>
              </div>
              <div>
                CUBRID Manager project:{' '}
                <a href={'https://github.com/CUBRID/cubrid-manager'} target={'_blank'}>
                  https://github.com/CUBRID/cubrid-manager
                </a>
              </div>
              <div>
                CUBRID Database project:{' '}
                <a href={'https://github.com/CUBRID'} target={'_blank'}>
