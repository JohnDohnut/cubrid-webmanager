...
const ViewDatabase = (props) => {
  ...
  return (
    <div style={{ padding: '8px 12px' }}>
      ...
      <Table bordered pagination={false} columns={dbInfoColumns} dataSource={dbSpace.dbinfo} />
      <Divider />
      <Table
        bordered
        pagination={false}
      ...
      <Table bordered pagination={false} columns={fileTypeColumns} dataSource={dbSpace.fileinfo} />
