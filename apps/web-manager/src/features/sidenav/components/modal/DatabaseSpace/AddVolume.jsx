...
const AddVolume = () => {
  ...
  const handleOk = async () => {
    form.validateFields().then(async (values) => {
      ...
      const response = await addVolumeAPI(activeHost, data).finally(() => {
      ...
      <div style={{ maxHeight: '500px', overflowY: 'auto' }}>
        <Form form={form} layout="horizontal">
          <div className={styles.db__layout}>
            <Row>
              <Col span={24}>
                <Form.Item name="path" labelCol={{ span: 5 }} label="Path: ">
                  <Input readOnly />
                </Form.Item>
              </Col>
              <Col span={24}>
                <Form.Item name="volname" labelCol={{ span: 5 }} label="Vol Name: ">
                  <Input />
                </Form.Item>
              </Col>
              <Col span={24}>
                <Form.Item name="purpose" labelCol={{ span: 5 }} label="Purpose: ">
                  <Select>
              ...
              <Col span={24}>
                <Form.Item name="size_need_mb" labelCol={{ span: 5 }} label="Volume (MB): ">
                  <Input type={'number'} />
                </Form.Item>
              </Col>
            </Row>
