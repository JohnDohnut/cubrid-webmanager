...
const SetAutoVolume = () => {
  ...
  const handleOk = async () => {
    form.validateFields().then(async (values) => {
      ...
      const response = await setAutoVolumeAPI(activeHost, data).finally(() => {
      ...
      <div style={{ maxHeight: '600px', overflowY: 'auto' }}>
        <Form form={form} layout="horizontal">
          <div className={styles.db__layout}>
            ...
            <Row gutter={[12, 6]}>
              <Col span={24}>
                <Checkbox name="data" checked={checkBoxFields.data} onChange={handleCheckBox}>
              ...
              <Col span={24}>
                ...
                >
                  <Select
                    ...
                    options={Array.from({ length: 30 - 5 + 1 }, (_, i) => ({
                      label: `${i + 5}`,
                      value: `${(i + 5) / 100}`,
                    }))}
                  />
              ...
              <Col span={12}>
                <Form.Item name="data_volume" label="Volume size (MB) : ">
                  <Input disabled={!checkBoxFields.data} />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item name="data_ext_page" label="Extension page: ">
          ...
          <div className={styles.db__layout}>
            ...
            <Row gutter={[12, 6]}>
              <Col span={24}>
                <Checkbox name={'index'} checked={checkBoxFields.index} onChange={handleCheckBox}>
                  Create volume automatically when out of space
                </Checkbox>
              </Col>
              <Col span={24}>
                <Form.Item
              ...
              <Col span={12}>
                <Form.Item name="index_volume" label="Volume size (MB) : ">
                  <Input disabled={!checkBoxFields.index} />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item name="index_ext_page" label="Extension page: ">
