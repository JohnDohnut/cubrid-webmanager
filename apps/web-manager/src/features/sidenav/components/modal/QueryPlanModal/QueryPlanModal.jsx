      ...
      >
        ...
        >
          <Row gutter={[12, 0]}>
            ...
            {/* User Input */}
            <Col span={24}>
              <Form.Item label="Peroid Type" name="period">
                <Select
            ...
            <Col span={24}>
              <Row gutter={[24, 0]}>
                <Col style={{ display: 'flex' }}>
                  <Radio checked={active === 'b'} onChange={() => setActive('b')}>
                    Run Specific Time
                  </Radio>
                </Col>
                <Col span={24}>
                  <Form.Item label={'Query Time'} name="timeA">
                    <Select
                      disabled={active !== 'b'}
                      showSearch={{
                        optionFilterProp: 'label',
            ...
            <Col span={24}>
              <Row>
                <Col style={{ display: 'flex' }}>
                  <Radio checked={active === 'a'} onChange={() => setActive('a')}>
                    Run Periodically
                  </Radio>
                </Col>
                <Col span={24}>
                  <Form.Item label={'Interval'} name="timeA">
                    <Select
                      disabled={active !== 'a'}
                      showSearch={{
                        optionFilterProp: 'label',
