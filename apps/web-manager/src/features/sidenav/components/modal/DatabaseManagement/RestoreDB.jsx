...
import { setRestoreDB } from '../../../sideNavSlice';

export default function () {
  const { restoreDB } = useSelector((state) => state.sidenav);
      ...
      <div style={{ overflowY: 'auto' }}>
        <Form form={form} layout="horizontal">
          <div className={styles.db__layout}>
            ...
            <Row gutter={[12, 6]}>
              <Col span={24}>
                <Form.Item name="dbname" labelCol={{ span: 6 }} label="Database Name">
                  <Input readOnly />
                </Form.Item>
              </Col>
            </Row>
          ...
          <div className={styles.db__layout}>
            ...
            <Row gutter={[12, 6]}>
              ...
              <Col span={24}>
                <Form.Item>
                  <Radio.Group
                    defaultValue={'normal'}
                    style={{ width: '100%' }}
                    disabled={!checkBoxFields.selectDatetime}
              ...
              <Col span={24}>
                <Checkbox
                  name={'backupInfo'}
                  value={checkBoxFields.backupInfo}
                  onChange={handleCheckBox}
                >
                  {' '}
                  Select A validation backup information
                </Checkbox>
              </Col>
              ...
              <Col span={24}>
                <Radio.Group
                  style={{ width: '100%' }}
                  disabled={!checkBoxFields.backupInfo}
