...
export default function () {
  ...
  const handleOk = () => {
    form.validateFields().then(async (values) => {
      ...
      const response = await backupDBAPI(activeHost, data).finally(() => {
    ...
    <>
      ...
      >
        <Form form={form} autoComplete="off" layout="horizontal">
          <Row gutter={[12, 6]}>
            <Col span={24}>
              <Form.Item label="Database" name="dbname" labelCol={{ span: 6 }}>
                <Input readOnly />
              </Form.Item>
            </Col>
            <Col span={24}>
            ...
            <Col span={24}>
              <Form.Item label="Backup Level" name="level" labelCol={{ span: 6 }}>
                <Input />
              </Form.Item>
            </Col>
            ...
            <Col span={24}>
              <Form.Item label="Parallel Backup" name="mt" labelCol={{ span: 6 }}>
                <Input type="number" />
              </Form.Item>
            </Col>
            <Col span={18}>
              <Checkbox name="check" checked={checkBoxFields.check} onChange={handleCheckBox}>
                Check Database Consistency
              </Checkbox>
              <br />
              <Checkbox
                name="removelog"
                checked={checkBoxFields.removelog}
                onChange={handleCheckBox}
              >
                Delete Unnecessary log-achieves
              </Checkbox>
              <br />
              <Checkbox name="zip" checked={checkBoxFields.zip} onChange={handleCheckBox}>
                Compress Backup Volumes
              </Checkbox>
            </Col>
