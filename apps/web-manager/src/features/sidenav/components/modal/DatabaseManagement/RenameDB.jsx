  ...
  const handleOk = async () => {
    form.validateFields().then(async (values) => {
      ...
      const data = {
        ...
        advanced: 'off',
        forcedel: values.forcedel ? 'y' : 'n',
      };
      const response = await renameDBAPI(activeHost, data).finally(() => {
        ...
        <Form form={form} layout="horizontal">
          <div className={styles.db__layout}>
            <Row gutter={[12, 6]}>
              ...
              <Col span={24}>
                <Form.Item name="exvolpath" labelCol={{ span: 6 }} label="External Volume Path">
                  <Input />
                </Form.Item>
              </Col>
            </Row>
