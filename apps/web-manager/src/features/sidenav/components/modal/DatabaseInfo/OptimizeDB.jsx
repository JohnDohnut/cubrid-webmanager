...
const OptimizeDB = () => {
  ...
  const handleOk = async () => {
    ...
    setContent((prevState) => [
      ...prevState,
      `Optimize Success: ${values.table === 'all' ? 'All tables in database' : tableName}`,
    ]);
    // Modal.success({
    //     title: 'Success',
      ...
      <div style={{ maxHeight: '400px', overflowY: 'auto' }}>
        <div className={styles.db__layout}>
          ...
          <Form form={form} layout="horizontal" name="create_user_form">
            <Form.Item name="table" label="Table Name: ">
              <Select>
        ...
        <div className={styles.db__layout}>
          ...
          <div>
            The query optimizer uses statistical information such as the number of objects in a
            table, the number of pages to access and the distribution of attribute values.
          </div>
        </div>
