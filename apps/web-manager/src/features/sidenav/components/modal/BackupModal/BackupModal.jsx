      ...
      >
        ...
        >
          <Row gutter={[18, 0]}>
            ...
            <Col span={24}>
              <Form.Item label="Backup Level" name="level">
                <Select
                  options={[
            ...
            {/* User Input */}
            <Col span={24}>
              <Form.Item label="Peroid Type" name="period_type">
                <Select
            ...
            <Col span={24}>
              <Form.Item label="Backup Time" name="time">
                <Select
                  showSearch={{
            ...
            <Col span={8}>
              <Form.Item labelCol={{ span: 16 }} label="Number of threads" name="mt">
                <Input type={'number'} />
              </Form.Item>
            </Col>
                ...
                <Radio.Group
                  options={[
                    { value: 'ON', label: 'Online backup' },
                    {
                      value: 'OF',
                      label:
                        'Offline backup (Notice: Database will be stopped during backup operation and then restarted)',
                    },
                  ]}
                />
              </Form.Item>
            ...
            <Col span={24} style={{ marginTop: 24 }}>
              <Form.Item wrapperCol={{ span: 24 }}>
                ...
                >
                  <Col>
                    <Button type={'primary'} className={'button button__small'} htmlType="submit">
                      Save
                    </Button>
                  </Col>
                  <Col>
